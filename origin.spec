...
sed -i "s|@@PACKAGE_LIST-VARIABLE@@|docker*1.14* docker*1.15* docker*1.16* docker*1.17* docker*1.18* docker*1.19* docker*1.20* docker-*17.* docker-*18.* docker-*19.* docker-*20.* |" $RPM_BUILD_ROOT/usr/sbin/%{name}-docker-excluder
